    ...
    <footer className="bg-dark-secondary border-t border-dark-border mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="font-bold text-lg text-text-primary mb-2">Wanani Mamidza</h3>
            <p className="text-text-secondary text-sm">Computer Science Student | Software Developer</p>
          </div>
        ...
        <div className="border-t border-dark-border pt-8">
          <p className="text-text-muted text-sm text-center">
            © {currentYear} Wanani Mamidza. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
